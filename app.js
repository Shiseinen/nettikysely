...
(function dartProgram() {
  ...
  K = {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t2 = t1.$ti;
              t3 = t2._eval$1("~(1)?")._as(new K.main_closure(kysymykset));
              type$.nullable_void_Function._as(null);
    ...
    asetaVastausvaihtoehdot: function(vaihtoehdot) {
      ...
      while (true) {
        ...
        if (!(i < t2))
          break;
        K.lisaaVastausvaihtoehto(t1.$index(vaihtoehdot, i));
        ++i;
      }
    },
    lisaaVastausvaihtoehto: function(vaihtoehto) {
      ...
      t3 = t2._eval$1("~(1)?")._as(new K.lisaaVastausvaihtoehto_closure(vaihtoehto, elementti));
      type$.nullable_void_Function._as(null);
  ...
  K.main_closure.prototype = {
    call$1: function(e) {
      ...
      K.asetaVastausvaihtoehdot(t2.$index(t1, "vaihtoehdot"));
    },
    $signature: 4
  };
  K.lisaaVastausvaihtoehto_closure.prototype = {
    call$1: function(e) {
      var t1;
      type$.legacy_MouseEvent._as(e);
      t1 = this.elementti;
