...
(function dartProgram() {
  ...
  T = {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t2 = t1.$ti;
              t3 = t2._eval$1("~(1)?")._as(new T.main_closure(kysymykset));
              type$.nullable_void_Function._as(null);
    ...
    asetaVastausvaihtoehdot: function(vaihtoehdot) {
      ...
      while (true) {
        ...
        if (!(i < t2))
          break;
        T.lisaaVastausvaihtoehto(t1.$index(vaihtoehdot, i));
        ++i;
      }
    },
    lisaaVastausvaihtoehto: function(vaihtoehto) {
      ...
      t3 = t2._eval$1("~(1)?")._as(new T.lisaaVastausvaihtoehto_closure(vaihtoehto, elementti));
      type$.nullable_void_Function._as(null);
  ...
  T.main_closure.prototype = {
    call$1: function(e) {
      ...
      T.asetaVastausvaihtoehdot(t2.$index(t1, "vaihtoehdot"));
    },
    $signature: 4
  };
  T.lisaaVastausvaihtoehto_closure.prototype = {
    call$1: function(e) {
      var t1;
      type$.legacy_MouseEvent._as(e);
      t1 = this.elementti;
